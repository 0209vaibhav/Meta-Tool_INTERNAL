...
// Instruction Buttons Functionality
const instructionBox = document.getElementById('instruction-box');
const instructions = {
    step1: 'Wear the headband in a comfortable position, ensuring it fits snugly but not too tight.',
    step2: 'Click the "Reset All" button to restart the process if default angles are already visible.',
    step3: 'Record your middle center gaze pattern by looking naturally and clicking "Record".',
    step4: 'Repeat the recording process for all remaining gaze patterns to complete setup.',
    step5: 'Verify your recorded angles. If unsatisfied, re-record until comfortable.',
    step6: 'Ensure live gyroscope data updates are visible under "Live Gyroscope Data".',
    step7: 'Click "Start Tracking" to begin tracking your gaze pattern.',
    step8: 'Allow a few seconds for tracking to appear. Reload if needed.',
    step9: 'Monitor your real-time gaze patterns, including counts and time.',
    step10: 'Explore visualizations to understand how gaze patterns relate to activities.'
};

document.querySelectorAll('.instructions-buttons button').forEach(button => {
